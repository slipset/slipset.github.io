...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__21837){
...
return cljs.core.get_in.call(null,new_db,p1__21838_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__21839_SHARP_){
return cljs.core.get_in.call(null,db,p1__21839_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__21840__i = 0, G__21840__a = new Array(arguments.length -  2);
while (G__21840__i < G__21840__a.length) {G__21840__a[G__21840__i] = arguments[G__21840__i + 2]; ++G__21840__i;}
  in_paths = new cljs.core.IndexedSeq(G__21840__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__21841){
var f = cljs.core.first(arglist__21841);
arglist__21841 = cljs.core.next(arglist__21841);
var out_path = cljs.core.first(arglist__21841);
var in_paths = cljs.core.rest(arglist__21841);
...
//# sourceMappingURL=middleware.js.map?rel=1513106853454