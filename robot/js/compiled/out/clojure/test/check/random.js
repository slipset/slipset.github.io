...
var x__20460__auto__ = (((rng == null))?null:rng);
var m__20461__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__20460__auto__)]);
if(!((m__20461__auto__ == null))){
return m__20461__auto__.call(null,rng);
} else {
var m__20461__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__20461__auto____$1 == null))){
return m__20461__auto____$1.call(null,rng);
} else {
...
var x__20460__auto__ = (((rng == null))?null:rng);
var m__20461__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__20460__auto__)]);
if(!((m__20461__auto__ == null))){
return m__20461__auto__.call(null,rng);
} else {
var m__20461__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__20461__auto____$1 == null))){
return m__20461__auto____$1.call(null,rng);
} else {
...
var x__20460__auto__ = (((rng == null))?null:rng);
var m__20461__auto__ = (clojure.test.check.random.split[goog.typeOf(x__20460__auto__)]);
if(!((m__20461__auto__ == null))){
return m__20461__auto__.call(null,rng);
} else {
var m__20461__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__20461__auto____$1 == null))){
return m__20461__auto____$1.call(null,rng);
} else {
...
var x__20460__auto__ = (((rng == null))?null:rng);
var m__20461__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__20460__auto__)]);
if(!((m__20461__auto__ == null))){
return m__20461__auto__.call(null,rng,n);
} else {
var m__20461__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__20461__auto____$1 == null))){
return m__20461__auto____$1.call(null,rng,n);
} else {
...
return clojure.test.check.random.longs.bit_xor.call(null,G__21997,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__21997;
}
});
...
var G__22000 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__22001 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__22000;
ret = G__22001;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__20399__auto__,writer__20400__auto__,opt__20401__auto__){
return cljs.core._write.call(null,writer__20400__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__19747__auto__ = clojure.test.check.random.longs.__GT_long.call(null,seed);
...
var state = cljs.core.get.call(null,map__22003__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__22005 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__22005,(0),null);
var r2 = cljs.core.nth.call(null,vec__22005,(1),null);
...
var args22006 = [];
var len__20930__auto___22009 = arguments.length;
var i__20931__auto___22010 = (0);
while(true){
if((i__20931__auto___22010 < len__20930__auto___22009)){
args22006.push((arguments[i__20931__auto___22010]));

var G__22011 = (i__20931__auto___22010 + (1));
i__20931__auto___22010 = G__22011;
continue;
} else {
}
break;
...
//# sourceMappingURL=random.js.map?rel=1513106853994