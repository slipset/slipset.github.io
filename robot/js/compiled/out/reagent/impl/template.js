...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20399__auto__,writer__20400__auto__,opt__20401__auto__){
return cljs.core._write.call(null,writer__20400__auto__,"reagent.impl.template/NativeWrapper");
});
...
var temp__6146__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var k_SINGLEQUOTE_ = temp__6146__auto__;
...
var G__21473 = o;
(G__21473[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var temp__6146__auto__ = (id_class["className"]);
if((temp__6146__auto__ == null)){
return p__$1;
} else {
var class$ = temp__6146__auto__;
...
var temp__6148__auto__ = (this$["cljsInputValue"]);
if((temp__6148__auto__ == null)){
return null;
} else {
var value = temp__6148__auto__;
...
if(cljs.core.truth_((function (){var and__19735__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__19735__auto__){
var and__19735__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__19735__auto____$1){
var and__19735__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__21481 = jsprops;
(G__21481["defaultValue"] = value);

(G__21481["onChange"] = ((function (G__21481,v,value,on_change){
return (function (p1__21479_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21479_SHARP_);
});})(G__21481,v,value,on_change))
);
...
var vec__21486 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21486,(0),null);
var id = cljs.core.nth.call(null,vec__21486,(1),null);
var class$ = cljs.core.nth.call(null,vec__21486,(2),null);
...
var temp__6146__auto__ = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
if((temp__6146__auto__ == null)){
return reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null));
} else {
var k = temp__6146__auto__;
return k;
}
});
...
var jsprops = {"argv": v};
var temp__6148__auto___21489 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6148__auto___21489 == null)){
} else {
var key_21490 = temp__6148__auto___21489;
(jsprops["key"] = key_21490);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__21492 = (new reagent.impl.template.NativeWrapper());
(G__21492["name"] = c);
...
var temp__6146__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__6146__auto__ == null)){
return (reagent.impl.template.tag_name_cache[x] = reagent.impl.template.parse_tag.call(null,x));
} else {
var s = temp__6146__auto__;
return s;
}
});
...
var len__20930__auto___21498 = arguments.length;
var i__20931__auto___21499 = (0);
while(true){
if((i__20931__auto___21499 < len__20930__auto___21498)){
args__20937__auto__.push((arguments[i__20931__auto___21499]));

var G__21500 = (i__20931__auto___21499 + (1));
i__20931__auto___21499 = G__21500;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__20938__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21496){
var G__21497 = cljs.core.first.call(null,seq21496);
var seq21496__$1 = cljs.core.next.call(null,seq21496);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__21497,seq21496__$1);
});
...
break;
default:
var G__21504 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__21504;
continue;
...
var n__20760__auto___21505 = a.length;
var i_21506 = (0);
while(true){
if((i_21506 < n__20760__auto___21505)){
(a[i_21506] = reagent.impl.template.as_element.call(null,(a[i_21506])));
...
var a = cljs.core.into_array.call(null,s);
var n__20760__auto___21508 = a.length;
var i_21509 = (0);
while(true){
if((i_21509 < n__20760__auto___21508)){
var val_21510 = (a[i_21509]);
if((cljs.core.vector_QMARK_.call(null,val_21510)) && ((reagent.impl.template.key_from_vec.call(null,val_21510) == null))){
(o["no-key"] = true);
} else {
}

(a[i_21509] = reagent.impl.template.as_element.call(null,val_21510));
...
var ctx = {};
var vec__21513 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21513,(0),null);
var derefed = cljs.core.nth.call(null,vec__21513,(1),null);
...
var G__21515 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21515) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__21515){
...
//# sourceMappingURL=template.js.map?rel=1513106852177